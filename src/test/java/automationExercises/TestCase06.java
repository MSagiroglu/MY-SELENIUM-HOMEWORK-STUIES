...
public class TestCase06 extends TestBase {
    ...
    public void test01() throws IOException {
        ...
        dosyaSec.sendKeys("C:\\Users\\Mustafa-PC\\Desktop\\Excel-To-Do-List-Template-Checklist_v1.xlsx");
        ...
        String dosyaYolu = "src/test/java/Screen_Shots/TumSayfaResmi/Mustafa " +tarih + ".jpeg";
        String dosyaYolu2 = "src/test/java/Screen_Shots/ElementResmi/Mustafa " +tarih + ".jpeg";
        ...
        FileUtils.copyFile(success.getScreenshotAs(OutputType.FILE), new File(dosyaYolu2));
        ...
        String expected = "rgba(105, 103, 99, 1)";
