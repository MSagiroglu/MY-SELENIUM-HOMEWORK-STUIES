...
public class Q10 extends TestBase {
    ...
    public void test01() {
        ...
        System.out.println(height601.getText());
        System.out.println("//////////////////////////////////////");
    ...
    private void   printData(int body ,int satir, int sutun) {
        WebElement satirSutun=driver.findElement(By.xpath("(//tbody)["+body+"]//tr["+satir+"]//td["+sutun+"]"));

        System.out.println(satir+". ve "+sutun+". sütun = "+satirSutun.getText());
    }
}
